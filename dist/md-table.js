...
(function (native_require, this_module) {
    ...
    // BEGIN FILE ./md-data-table.js
    require.register("./md-data-table.js", function (module, exports, require) {

angular.module('ng1.md.data.table', []);

    });
    // END FILE

    // BEGIN FILE ./scripts/mdBody.js
    require.register("./scripts/mdBody.js", function (module, exports, require) {
...
function mdBody() {
    ...
    // BEGIN FILE ./scripts/mdCell.js
    require.register("./scripts/mdCell.js", function (module, exports, require) {

'use strict';
angular.module('ng1.md.data.table').directive('mdCell', mdCell);
function mdCell() {
    function compile(tElement) {
    ...
    // BEGIN FILE ./scripts/mdColumn.js
    require.register("./scripts/mdColumn.js", function (module, exports, require) {
...
mdColumn.$inject = ['$compile', '$mdUtil'];
    ...
    // BEGIN FILE ./scripts/mdEditDialog.js
    require.register("./scripts/mdEditDialog.js", function (module, exports, require) {
...
mdEditDialog.$inject = ['$compile', '$controller', '$document', '$mdUtil', '$q', '$rootScope', '$templateCache', '$templateRequest', '$window'];
    ...
    // BEGIN FILE ./scripts/mdFoot.js
    require.register("./scripts/mdFoot.js", function (module, exports, require) {

'use strict';
angular.module('ng1.md.data.table').directive('mdFoot', mdFoot);
function mdFoot() {
    function compile(tElement) {
    ...
    // BEGIN FILE ./scripts/mdHead.js
    require.register("./scripts/mdHead.js", function (module, exports, require) {

'use strict';
angular.module('ng1.md.data.table').directive('mdHead', mdHead);
...
mdHead.$inject = ['$compile'];
    ...
    // BEGIN FILE ./scripts/mdRow.js
    require.register("./scripts/mdRow.js", function (module, exports, require) {

'use strict';
angular.module('ng1.md.data.table').directive('mdRow', mdRow);
function mdRow() {
    function compile(tElement) {
    ...
    // BEGIN FILE ./scripts/mdSelect.js
    require.register("./scripts/mdSelect.js", function (module, exports, require) {
...
mdSelect.$inject = ['$compile', '$parse'];
    ...
    // BEGIN FILE ./scripts/mdTable.js
    require.register("./scripts/mdTable.js", function (module, exports, require) {

'use strict';
angular.module('ng1.md.data.table').directive('mdTable', mdTable);
function Hash() {
    var keys = {};
...
function mdTable() {
    ...
    // BEGIN FILE ./scripts/mdTablePagination.js
    require.register("./scripts/mdTablePagination.js", function (module, exports, require) {

'use strict';
var mdTablePaginationTemplate_1 = require("../templates/mdTablePaginationTemplate");
...
function mdTablePagination() {
    ...
    return {
        ...
        restrict: 'E',
        scope: {},
        template: mdTablePaginationTemplate_1.mdTablePaginationTemplate
    };
}
    ...
    // BEGIN FILE ./scripts/mdTableProgress.js
    require.register("./scripts/mdTableProgress.js", function (module, exports, require) {

'use strict';
var mdTableProgressTemplate_1 = require("../templates/mdTableProgressTemplate");
...
function mdTableProgress() {
    ...
    return {
        ...
        restrict: 'C',
        scope: {},
        template: mdTableProgressTemplate_1.mdTableProgressTemplate
    };
}
    ...
    // BEGIN FILE ./scripts/virtualPageSelect.js
    require.register("./scripts/virtualPageSelect.js", function (module, exports, require) {

'use strict';
angular.module('ng1.md.data.table').directive('virtualPageSelect', virtualPageSelect);
